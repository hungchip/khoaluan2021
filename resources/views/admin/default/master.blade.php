...
<head>
    ...
    <title>Quản trị Anh Em Hotel</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}"
                ...
                <div class="sidebar-brand-text mx-3"><img src="{{asset('public/hotel/images/logoae.png')}}" alt=""
                        style="width: 100%;"></div>
            </a>
            ...
            {{-- <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAdminRoom"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-bed"></i>
                    <span>Quản lý phòng</span>
                </a>
                <div id="collapseAdminRoom" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item" href="">Sơ đồ phòng</a>
                        <a class="collapse-item" href="">Đặt phòng</a>
                    </div>
                </div>
            </li> --}}
            <!-- bài viết  -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Xin Chào
                                    {{Auth::guard('admin')->user()->admin_name}}</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item"
                                    href="{{route('admin.show',Auth::guard('admin')->user()->admin_id)}}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Thông tin tài khoản
                                </a>
                                <a class="dropdown-item" href="{{route('getChangePassword')}}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Bạn có chắc đăng xuất?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Chọn "Đăng xuất" để kết thúc phiên.</div>
