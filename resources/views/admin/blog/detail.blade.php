            ...
            <form action="" class="user" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <h4 class=" mb-2 text-dark">Tên bài viết</h4>
                        <p> {{$blog->title}}</p>
                    </div>
                    <div class="col-sm-6">
                        <h4 class=" mb-2 text-dark">Tác giả</h4>
                        <p> {{$blog->admin->admin_name}}</p>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12 ">
                        ...
                        <img src="{{asset('public/image/blog/')}}/{{$blog->thumbnail}}" alt="" width="300">
                ...
                <div class="form-group">
                    ...
                    <p name="info" id="" rows="5">{!!$blog->content!!}</p>
