<div style="background-color:white;padding:20px;max-width:860px;margin:auto">
    ...
    <table cellpadding="4" cellspacing="0" border="0" style="width:100%">
        <tbody>
            ...
            <tr>
                <td style="white-space:nowrap;width:80%;text-align:left">
                    <strong>Tổng cộng số tiền phải thanh toán (VND)</strong>
                </td>
                <td style="width:20%;text-align:right">
                    <strong>{{number_format($totalPrice * $abs_diff)}}</strong>
                </td>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="4" style="vertical-align:top;font-weight:bold;text-align:center;">
                    <span style="color:red">Quý khách vui lòng thanh toán trong vòng 48h, nếu không đơn đặt phòng sẽ bị hủy</span>
                </td>
            </tr>
        </tbody>
    </table>
